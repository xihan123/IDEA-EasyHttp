...
object HttpSslFactory {
     ...
     * https 单向认证
     */
    fun generateSslConfig(vararg certificates: InputStream): HttpSslConfig {
     ...
     * https 双向认证
     */
    fun generateSslConfig(bksFile: InputStream?, password: String?, vararg certificates: InputStream): HttpSslConfig {
     ...
     * https 双向认证
     */
    fun generateSslConfig(bksFile: InputStream?, password: String?, trustManager: X509TrustManager?): HttpSslConfig {
    ...
    private fun generateSslConfigBase(
        ...
        return try {
            ...
            manager = // 优先使用用户自定义的 TrustManager
                trustManager
